        ...
        <div class="col-md-offset-3 col-md-6">
            <form role="form" action="<?php echo base_url('users/add/') ?>" method="post">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label>Company</label>
                                    <input type="text" name="company" class="form-control" value="" placeholder="Company">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input name="username" class="form-control" value="" placeholder="User Name">
                                      <?php if($error['username']){ echo "<div class='col-lg-12 errormsg'>".$error['username']."</div>";}?>
                                </div>
                                  <div class="form-group">
                                    <label>Password*</label>
                                    <input name="password" type="password" class="form-control" value="" placeholder="User Name">
