<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h2>
                City
                <a  href="<?php echo base_url('admin/cities') ?>" class="btn btn-warning">Go back to City listing</a>
            </h2>
        </div>
        <!-- /.col-lg-12 -->
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" action="<?php echo base_url('admin/cities/city_add') ?>" method="post" enctype="multipart/form-data">
